...
<%
	...
	addrDao.insertEmployerAddr(addr); //직원 번호데이터와 직원 주소 데이터가 저장된 직원 주소객체 주소값을 매개변수로 대입
