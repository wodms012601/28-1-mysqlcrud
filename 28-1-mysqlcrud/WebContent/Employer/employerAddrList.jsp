...
<%
	...
	ArrayList<EmployerAddr> employerAddrList = employerAddrDao.selectEmployerAddrList(currentPage, pagePerRow, addrKeyword);
	
	int lastPage = employerAddrDao.paging(pagePerRow, addrKeyword); //페이징 작업 후 마지막 페이지값을 리턴
%>
<html>
	<head>
