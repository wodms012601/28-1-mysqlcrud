				...
				<fieldset>
					...
					<table>
						<tr><!-- 이름 -->
							...
							<td>이름 :&nbsp;</td>
							<td>
								<input type="text" name="employerName" id="name" onkeyup="nameCheck()" required>
						...
						<tr><!-- 나이 -->
							...
							<td>나이 :&nbsp;</td>
							<td>
								<input type="text" name="employerAge" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' style='ime-mode:disabled;' onfocusout='removeChar(event)' required>
